...
export function DashboardPage() {
  ...
  const stats = [
    { label: 'Total Trades', value: user?.totalTrades || 0, icon: Package, change: '+12%', color: 'text-blue-500' },
    { label: 'Trust Score', value: user?.trustScore || 0, icon: Star, change: '+5 pts', color: 'text-yellow-500' },
    { label: 'Active Listings', value: 8, icon: TrendingUp, change: '+2', color: 'text-green-500' },
    { label: 'Messages', value: 14, icon: MessageSquare, change: '7 new', color: 'text-purple-500' },
  ];
  ...
  const activeListings = [
    ...
    { id: '2', title: 'Professional Photography', views: 189, inquiries: 8, type: 'offer' },
    { id: '3', title: 'Need: Moving Help', views: 156, inquiries: 15, type: 'request' },
  ];
          ...
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <Progress value={user?.trustScore} className="mb-4" />
